...
const VARIANT: Record<ButtonVariant, string> = {
	...
	ghost:
		'p-1 text-15 rounded-control bg-transparent border-none text-text-muted hover:text-text-primary hover:bg-bg-hover',
	...
	badge:
		'px-2.5 py-0.5 text-11 font-semibold uppercase tracking-wider rounded-full bg-bg-panel border border-border-strong text-accent hover:not-disabled:border-accent disabled:text-text-muted',
