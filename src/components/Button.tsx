...
const VARIANT: Record<ButtonVariant, string> = {
	...
	secondary:
		'px-5 py-2 text-[13px] border border-border-strong bg-bg-panel text-text-secondary hover:bg-bg-hover hover:text-text-primary',
	danger:
	...
	pill: 'px-6 py-2.5 text-[13px] border border-border-strong rounded-[20px] bg-bg-panel text-text-secondary hover:not-disabled:bg-bg-hover hover:not-disabled:text-text-primary hover:not-disabled:border-accent',
